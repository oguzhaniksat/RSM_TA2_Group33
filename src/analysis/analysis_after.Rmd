...
# read final data
dt_after <- fread('../../gen/analysis/temp/preclean_after.csv')
```
...
ggplot(dt_after, aes(x=polarity, color=retweet)) +
...
```{r}
#histogram of the subjectivity of the subjectivity
Subjectivity <- dt_after$subjectivity
hist(Subjectivity, breaks = 50)
```

```{r}
# Overlaid histograms
ggplot(dt_after, aes(x=subjectivity, color=retweet)) +
